...
class ConnectFourImplTest {
    ...
    void testDropAndGetPlayerAt(int col, Player player) {
        ...
        assertEquals(player, connectFour.getPlayerAt(5, col));
    }
    ...
    void testStackingDrops(int col) {
        ...
        assertEquals(Player.yellow, connectFour.getPlayerAt(4, col));
        assertEquals(Player.red, connectFour.getPlayerAt(3, col));
    }
